...
mod_read_ckan_server <- function(id, r){
  moduleServer( id, function(input, output, session){
    ...
    infoUrl <- reactive({
      ...
      linkInfo <- r$url_par
      if (is.null(linkInfo)) linkInfo <-"d543a7b1-f8cb-439f-8a5c-e56c5479eeb5"    # "ff1d4cbf-5985-45db-b40f-d820ce2b01a2"#"140e35f9-9244-4b45-b638-816c2ab7651a"#"ff1d4cbf-5985-45db-b40f-d820ce2b01a2"#"d543a7b1-f8cb-439f-8a5c-e56c5479eeb5"###"2263bf74-c0ed-4e7c-bb9c-73f0624ac1a9" #"b089368e-f710-4f4b-9bae-f9f154d46220" 
